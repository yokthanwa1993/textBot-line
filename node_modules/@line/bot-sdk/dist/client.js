...
class Client {
    ...
    async createUploadAudienceGroupByFile(uploadAudienceGroup) {
        ...
        const res = await this.http.postFormMultipart(`${endpoints_1.DATA_API_PREFIX}/audienceGroup/upload/byFile`, body);
        return (0, utils_1.ensureJSON)(res);
    }
    ...
    httpConfig) {
        const file = await this.http.toBuffer(uploadAudienceGroup.file);
        const body = (0, utils_1.createMultipartFormData)(Object.assign(Object.assign({}, uploadAudienceGroup), { file }));
        const res = await this.http.putFormMultipart(`${endpoints_1.DATA_API_PREFIX}/audienceGroup/upload/byFile`, body, httpConfig);
        return (0, utils_1.ensureJSON)(res);
    }
...
class OAuth {
    ...
    verifyIdToken(id_token, client_id, nonce, user_id) {
        ...
        return this.http.postForm(`${endpoints_1.OAUTH_BASE_PREFIX_V2_1}/verify`, body);
    }
